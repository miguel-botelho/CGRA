...
LightingScene.prototype.init = function(application) {
	...
	this.parede.setAmbient(0.9,1,0.8,1);
	this.parede.setDiffuse(0.9,1,0.8,1);
	this.parede.setSpecular(0,0,0,1);
	this.parede.setShininess(1);
	...
	this.cylinderAppearance.loadTexture("slides.png");
